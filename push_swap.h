...
/*   Updated: 2022/03/14 23:14:37 by iouazzan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_arra_maximal_negative(t_stack *arra, t_stack *arrb, t_actions *mouves);
void	ft_arrb_maximal_negative(t_stack *arra, t_stack *arrb, t_actions *mouves);
...
void	ft_arra_maximal_positive(t_stack *arra, t_stack *arrb, t_actions *mouves);
void	ft_arrb_maximal_positive(t_stack *arra, t_stack *arrb, t_actions *mouves);
void	ft_arra_arrb_equal_positive(t_stack *arra, t_stack *arrb,
			t_actions *mouves);
void	ft_arra_arrb_positive(t_stack *arra, t_stack *arrb, t_actions *mouves);
